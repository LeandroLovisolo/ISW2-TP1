...
\begin{stories}
  ...
  \begin{tasks}
    \task{Modificar componente de selección de destinatarios para sólo permitir seleccionar alumnos del maestro y sus respectivos profesores cuando el usuario actual tenga el rol de maestro}
  \end{tasks}
