...
La idea atras de estos repositorios fue la de desligar a los objetos de la responsabilidad de persistirse,
...
cambio de fecha y contenido del mensaje, además del método \textit{aceptar} que usará el visitor descripto 
posteriormente.

Consideramos el uso de estados importante para mantener el caracter inmutable de un mensaje ya enviado.
...
permitirá decidir utilizando el método \textit{comparar} si la campañana es eficaz o no.
...
resultado obtenido, delegando la responsabilidad al objeto que la implementa y conservando así la escencia del resultado 
como objeto.

Por último, la clase \textit{Comparador de campañas} tiene como objetivo realizar la comparación de dos campañas utilizando 
lo descripto anteriormente y devolviendo un \textit{ResultadoDeComparación} para luego por ejemplo, 
...
contraseña que utilizaran directivos y maestros para acceder al sistema.
