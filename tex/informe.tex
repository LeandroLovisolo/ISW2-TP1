...
\begin{stories}
  \story{director, secretario ó maestro}
        ...
        {darlo de alta en el sistema}
  \begin{itemize}
   \item ingresar la fecha del evento
   \item ingresar la descripción del evento
   \item cargar el evento en el sistema
  \end{itemize}
  ...
  \story{director, secretario ó maestro}
        ...
        {crear una campaña asociada al evento seleccionado}
  \begin{itemize}
   \item mostrar todas los eventos que aún no hayan ocurrido.
   \item seleccionar el evento deseado
   \item crear nombre de la campaña
   \item cargar la campaña en el sistema
  \end{itemize}
  ...
  \story{maestro}
        ...
        {asignarlos como destinatarios de una campaña que yo creé}
  \begin{itemize}
   \item mostrar todas las campañas que creé
   \item seleccionar la campaña deseada
   \item mostrar todos los alumnos que tengo a cargo
   \item seleccionar un subconjunto de alumnos
   \item cargar alumnos a la campaña
  \end{itemize}
  ...
  \begin{itemize}
   \item mostrar todas las campañas que creé
   \item seleccionar la campaña deseada
   \item mostrar todos los alumnos del colegio
   \item seleccionar un subconjunto de alumnos
   \item cargar alumnos a la campaña
  \end{itemize}
  ...
  \begin{itemize}
   \item mostrar todas las campañas que creé
   \item seleccionar la campaña deseada
   \item ingresar el mensaje
   \item ingresar fecha y hora en la que se desea enviar el mensaje
   \item ingresar si el mensaje es del tipo anuncio/recordatorio/asignación/mensaje de aliento
   \item cargar el mensaje en el sistema
  \end{itemize}
  ...
  \begin{itemize}
   \item mostrar todas las campañas que creé
   \item seleccionar la campaña deseada
   \item mostrar todos los mensajes que aún no se enviaron
   \item seleccionar el mensaje deseado
   \item si se desea eliminar:
   \begin{itemize}
    \item eliminar el mensaje del sistema
   \end{itemize}
   \item si se desea modificar:
   \begin{itemize}
    \item editar mensaje
    \item editar fecha y hora en la que se desea enviar el mensaje
    \item editar si el mensaje es del tipo anuncio/recordatorio/asignación/mensaje de aliento
    \item cargar el mensaje en el sistema
   \end{itemize}
  \end{itemize} 
