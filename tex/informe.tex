...
\begin{stories}
  ...
  \storyid{19}{director, secretario o maestro}
   ...
   \begin{criterios}
    ...
    \criteria{Se debe actualizar una columna booleana ``fue\_enviado'' en la tabla de mensajes con valor \emph{true} para todos los mensajes cuyo envío fue simulado.}
  \end{criterios}
